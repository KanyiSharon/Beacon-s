...
} elseif ($_instance->childHasBeenRendered('bSVeQoi')) {
    $componentId = $_instance->getRenderedChildComponentId('bSVeQoi');
    $componentTag = $_instance->getRenderedChildComponentTagName('bSVeQoi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bSVeQoi');
} else {
    $response = \Livewire\Livewire::mount('global-search');
    $html = $response->html();
    $_instance->logRenderedChild('bSVeQoi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div> 
<div class="ml-auto">
...
<?php /**PATH C:\Users\sharo\Downloads\Beacon's\BeaconChildrenCenter-1\resources\views/reception/header.blade.php ENDPATH**/ ?>