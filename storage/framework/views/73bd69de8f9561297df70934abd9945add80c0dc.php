...
} elseif ($_instance->childHasBeenRendered('aQbwoHK')) {
    $componentId = $_instance->getRenderedChildComponentId('aQbwoHK');
    $componentTag = $_instance->getRenderedChildComponentTagName('aQbwoHK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aQbwoHK');
} else {
    $response = \Livewire\Livewire::mount('child-search-bar');
    $html = $response->html();
    $_instance->logRenderedChild('aQbwoHK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
</html><?php /**PATH C:\Users\sharo\Downloads\Beacon's\BeaconChildrenCenter-1\resources\views/calendar.blade.php ENDPATH**/ ?>